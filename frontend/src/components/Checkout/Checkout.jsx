          ...
          <Box
            ...
            <div className="pt-5">
              ...
              <div>
                ...
                <div  className="col-3">
                    <img src="images/img/payment/g1.png" className="img-fluid"   alt="guarantee"/>
                    </div>
                    <div  className="col-9">
                    <h5 style={{fontSize: "15px"}}><strong>100% Satisfaction Guarantee</strong></h5>
                    <p style={{fontSize: "15px"}}>If you are not 100% satisfied with your purchase, we will make it right! No questions asked!</p>
                    </div>
                </div>
                <div  className="row" >
                <div  className="col-3">
                    <img src="images/img/payment/g2.png" className="img-fluid"  alt="guarantee"/>
                    </div>
                    <div  className="col-9">
                    <h4 style={{fontSize: "15px"}}><strong>Over 400,000 Successfully Shipped Orders</strong></h4>
                    <p style={{fontSize: "15px"}}>We make customers happy with every order we ship. You simply have to join our family.</p>
                    </div>
                </div>
                <hr/>
                <div className="d-flex justify-content-between">
