  ...
  return (
    <>
      ...
      <div className="container" style={{fontSize: "13px"}}>
        ...
        <img className="img-fluid pb-5" src="images/img/about/payment.svg" alt="payment-img" style={{height: "150px", width: "100%"}}/>

        <p><b>Payment methods include PayPal and Credit cards.</b></p>
        <p>
        ...
        <p><b>
          The reasons why we suggest you use PayPal:</b>
          <br />
