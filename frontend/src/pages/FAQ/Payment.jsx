      ...
      <div style={{ backgroundColor: "rgba(30, 40, 50, 0.05)" }}>
        <div className="container py-5" style={{ fontSize: "13px" }}>
          ...
          <p>
            ...
            account). When you use your credit card through PayPal, nobody will
            see your credit card number, which will minimize the risk of
            unauthorized use.
          </p>
          <p>
            ...
            (American Express, Discover, JCB, MasterCard, and Visa) to protect
            the buyers from cardholder information theft.
          </p>
          <p>
